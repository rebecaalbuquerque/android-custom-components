...
import com.albuquerque.customcomponents.extensions.format
import com.albuquerque.customcomponents.extensions.getCurrentBrazilianCalendar
import com.albuquerque.customcomponents.extensions.getPeriod
import com.albuquerque.customcomponents.extensions.toCustomDate
...
class CustomCalendar @JvmOverloads constructor(
    ...
    init {
        ...
        attributes.getInteger(R.styleable.CustomCalendar_customCalendarAvailability, -1).let { value ->
            availability = if(value == -1)
                ...
                CalendarAvailability.getByValue(value)
        }
    ...
    * */
    ...
    enum class CalendarAvailability(val value: Int) {
        ALL(0),                 // todos os meses disponívels
        BEFORE_CURRENT_DAY(1),  // meses anteriores até o dia atual disponível
        AFTER_CURRENT_DAY(2);   // dia atual até proximos meses disponível
